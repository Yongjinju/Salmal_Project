...
-- 댓글
-- (캣타워)
insert into REPLY(replyNum,memberNum,productNum,replyContent,replyDate,choice , parentNum, depth) values (reply_seq.nextval, 2, 13, '귀여운데 아직 안사도 될거같아요...', to_date('2019-09-05 10:31','yyyy-mm-dd hh24:mi'), 1, 0,0);
insert into REPLY(replyNum,memberNum,productNum,replyContent,replyDate,choice , parentNum, depth) values (reply_seq.nextval, 1, 13, '튼튼해보이네요', to_date('2019-09-05 15:42','yyyy-mm-dd hh24:mi'), 1, 0,0);
insert into REPLY(replyNum,memberNum,productNum,replyContent,replyDate,choice , parentNum, depth) values (reply_seq.nextval, 6, 13, '청소하기 힘들거같아요', to_date('2019-09-04 02:31','yyyy-mm-dd hh24:mi'), 0, 0,0);
insert into REPLY(replyNum,memberNum,productNum,replyContent,replyDate,choice , parentNum, depth) values (reply_seq.nextval, 3, 13, '이쁘네요', to_date('2019-09-05 18:11','yyyy-mm-dd hh24:mi'), 1, 0,0);
insert into REPLY(replyNum,memberNum,productNum,replyContent,replyDate,choice , parentNum, depth) values (reply_seq.nextval, 4, 13, '저거 집에 있는데 고양이들이 좋아해요', to_date('2019-09-06 07:11','yyyy-mm-dd hh24:mi'), 1, 0,0);
-- (브이로그)
insert into REPLY(replyNum,memberNum,productNum,replyContent,replyDate,choice , parentNum, depth) values (reply_seq.nextval, 2, 14, '저는 예쁜게 좋아요', to_date('2019-09-05 09:34','yyyy-mm-dd hh24:mi'), 1, 0,0);
insert into REPLY(replyNum,memberNum,productNum,replyContent,replyDate,choice , parentNum, depth) values (reply_seq.nextval, 1, 14, '튼튼한게 최고죠', to_date('2019-09-05 12:03','yyyy-mm-dd hh24:mi'), 1, 0,0);
insert into REPLY(replyNum,memberNum,productNum,replyContent,replyDate,choice , parentNum, depth) values (reply_seq.nextval, 3, 14, '튼튼한거 사서 오래쓰세요', to_date('2019-09-06 01:11','yyyy-mm-dd hh24:mi'), 1, 0,0);

-- 추천(rating)
-- (캣타워)
insert into RATING(productNum,memberNum,choice) values (3, 2, 1);
insert into RATING(productNum,memberNum,choice) values (3, 1, 1);
insert into RATING(productNum,memberNum,choice) values (3, 6, 0);
insert into RATING(productNum,memberNum,choice) values (3, 3, 1);
insert into RATING(productNum,memberNum,choice) values (3, 4, 1);
-- (브이로그)
insert into RATING(productNum,memberNum,choice) values (4, 2, 1);
insert into RATING(productNum,memberNum,choice) values (5, 1, 1);
insert into RATING(productNum,memberNum,choice) values (5, 3, 1);
insert into RATING(productNum,memberNum,choice) values (5, 4, 1);
insert into RATING(productNum,memberNum,choice) values (5, 6, 1);
